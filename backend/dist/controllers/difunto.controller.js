...
exports.deleteDifunto = exports.updateDifunto = exports.getDifuntosByOrden = exports.createDifunto = void 0;
 ...
 */
const createDifunto = async (req, res) => {
    try {
        const { orden_id, nombres, fecha_fallecido, lugar_fallecimiento, contacto_responsable, relacion_solicitante, notas, } = req.body;
...
exports.getDifuntosByOrden = getDifuntosByOrden;
/**
 ...
 */
const updateDifunto = async (req, res) => {
    try {
        const { id } = req.params;
        const { nombres, fecha_fallecido, lugar_fallecimiento, contacto_responsable, relacion_solicitante, notas, } = req.body;
        ...
        const difuntoActualizado = await prisma.difunto.update({
            ...
            data: {
                ...
                lugar_fallecimiento: lugar_fallecimiento ?? difuntoExistente.lugar_fallecimiento,
                contacto_responsable: contacto_responsable ?? difuntoExistente.contacto_responsable,
                relacion_solicitante: relacion_solicitante ?? difuntoExistente.relacion_solicitante,
...
exports.updateDifunto = updateDifunto;
/**
 * Elimina un registro de difunto por su id.
 * Ruta: DELETE /api/difuntos/:id
 */
const deleteDifunto = async (req, res) => {
    try {
        const { id } = req.params;
        // Verificar que exista el difunto
        const difuntoExistente = await prisma.difunto.findUnique({
...
exports.deleteDifunto = deleteDifunto;
//# sourceMappingURL=difunto.controller.js.map