...
const ctrl = __importStar(require("../controllers/import.controller"));
const upload = (0, multer_1.default)({ dest: 'uploads/' });
const router = (0, express_1.Router)();
// POST /api/importaciones/
// Sólo ADMIN puede importar datos históricos
router.post('/', auth_1.authMiddleware, (0, auth_1.requireRol)(['ADMIN']), upload.single('file'), ctrl.uploadCsv);
